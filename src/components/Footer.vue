<template>
    <!--===== FOOTER AREA STARTS =======-->
<div class="footer8-sertion-area" style="background-image: url(/assets/img/bg/header-bg8.png); background-position: center; background-size: cover; background-repeat: no-repeat">
  <div class="container">
    <div class="row">
